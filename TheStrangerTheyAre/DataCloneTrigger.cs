...
namespace TheStrangerTheyAre
{
    public class DataCloneTrigger : MonoBehaviour
    {
        ...
        private GameObject torch; // creates variable to store the vision torch
        ...
        void Start()
        {
            torch = SearchUtilities.Find("SCIENTIST_VISIONTORCH/VisionBeam/TriggerVolume_MindProjector");
        }
        ...
        public virtual void OnTriggerEnter(Collider hitCollider)
        {
            ...
            if (hitCollider.CompareTag("PlayerDetector") && enabled)
            {
                ...
                torch.GetComponent<ConeShape>().enabled = true; // enables vision torch cone so it can work!!!!
            }
        }
    }
}